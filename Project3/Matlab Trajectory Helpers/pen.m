...
%Save to workspace - JE
xvar_name = sprintf('x_pen_%d',num_blocks);
yvar_name = sprintf('y_pen_%d', num_blocks);
assignin('base',xvar_name, x_pen);
assignin('base',yvar_name, y_pen);
